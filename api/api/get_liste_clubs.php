...
function get_liste_clubs($settings, $objets){
	/*
		Script
		$objets['bdd']
	*/
	$base = $objets['bdd'];
	$request = $base->query("SELECT id, img, nom, description_courte, last_edit, is_active, facebook, twitter, googleplus FROM clubs ORDER BY id");
